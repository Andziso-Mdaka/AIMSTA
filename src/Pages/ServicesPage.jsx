...
export default function ServicesPage({ go }) {
  ...
  const setRef1    = useRevealList();
  const setRef2    = useRevealList();
      ...
      <section className="sec sec-mid">
        <div className="sec-inner">
          ...
          <div className="serv-grid">
            {SERVICES.map((s, i) => (
              <div key={i} ref={setRef1(i)} className="reveal serv-card" style={{ transitionDelay:`${i*.08}s` }}>
        ...
        <div className="sec-inner">
          ...
          <div className="serv-grid">
            {INCLUDED.map(([emoji, title, desc], i) => (
              <div key={i} ref={setRef2(i)} className="reveal serv-card" style={{ transitionDelay:`${i*.08}s` }}>
